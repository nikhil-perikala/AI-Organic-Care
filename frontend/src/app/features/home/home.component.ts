...
<div class="home-page">
  ...
  styles: [`
    ...
    /* ── Falling leaves ─────────────────────────────────── */
    .leaves-bg { position: fixed; inset: 0; pointer-events: none; overflow: hidden; z-index: 0; }
    ...
    .tip-banner-label { font-size: 10px; font-weight: 700; color: rgba(255,255,255,0.65); text-transform: uppercase; letter-spacing: 1px; margin-bottom: 2px; }
