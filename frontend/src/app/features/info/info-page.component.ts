...
const PAGE_MAP: Record<string, PageDef> = {
  about: {
    ...
    sections: [
      {
        heading: "Who We Are",
        body: "Organic Care is an AI-powered wellness platform that helps you eat smarter, live healthier, and make the most of what is already in your pantry. Founded in 2024, we combine cutting-edge retrieval-augmented AI with trusted nutritional science to deliver personalised meal plans, recipe recommendations, and wellness guidance.",
      },
      {
        heading: "Our Story",
    ...
    sections: [
      {
        ...
        body: "We believe food is medicine. Our mission is to help people understand how the organic foods they already buy can support their specific health goals — whether that means managing a condition, losing weight, building strength, or simply feeling more energised.",
      },
      {
  ...
  careers: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Send your CV and a brief note about why you want to join Organic Care to support@organiccare.ai with the subject line Careers — Role Name. We review all applications and respond within two weeks.",
      },
    ],
  },
  blog: {
  ...
  contact: {
    ...
    title: "Contact Us",
    subtitle: "We are here to help. Reach out and our team will respond within 24 hours.",
    sections: [
      {
      ...
      },
      {
        ...
        body: "You can also reach us on Instagram, LinkedIn, and Facebook at OrganicCareAI. We monitor our social channels during business hours and love hearing from our community.",
      },
    ],
  },
  help: {
  ...
  faqs: {
    ...
    sections: [
      ...
      {
        heading: "How does the AI know what is in my pantry?",
  ...
  feedback: {
    icon: "feedback",
    title: "Feedback",
    subtitle: "Your feedback makes Organic Care better. Tell us what you love, what is broken, and what you wish existed.",
    sections: [
      {
        heading: "Share Your Thoughts",
        body: "We read every piece of feedback we receive. Whether it is a bug report, a feature request, or a compliment — we want to hear it. Email us at support@organiccare.ai or use the thumbs up / thumbs down buttons in the AI chat to rate individual responses.",
      },
      {
        heading: "Report a Bug",
        body: "If something is not working correctly, please email support@organiccare.ai with a description of what happened, the steps to reproduce it, and your device and browser. Screenshots are always helpful.",
      },
    ],
  },
  terms: {
...
<div class="info-page" *ngIf="page">
  ...
  styles: [`
    ...
    .info-hero-icon mat-icon { font-size: 28px; color: #a5d6a7; }
    .info-title {
      font-size: 32px;
      font-weight: 800;
      color: #fff;
    ...
    .back-btn mat-icon { font-size: 18px; }
